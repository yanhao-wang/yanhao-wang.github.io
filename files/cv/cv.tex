...
\begin{itemize}[leftmargin=15pt,labelindent=-15pt,itemindent=-15pt,itemsep=0.1em]
  \item[] \textit{Social Sciences and Humanities Research Council of Canada (SSHRC)}
      \item[] \hspace{13pt} Insight Development Grant (Co-PI, CA\$72,357) \hfill 2025--2027
\item[] \textit{University of Alberta}
    \item[] \hspace{13pt} Alberta Innovates Postdoctoral Recruitment Fellowship (PI, CA\$70,000)\hfill 2024
\item[] \textit{Indiana University}
...
\vspace{1.8em}
\begin{itemize}[leftmargin=15pt,labelindent=-15pt,itemindent=-15pt,itemsep=0.1em]
\item[] \textit{2026}: NBER Economics of Health Program Meeting (Chicago)$^{\dagger}$, IIOC (Boston), CHESG Annual Meeting (Victoria)$^{*}$, ES North American Summer Meeting (Emory)$^{*}$
\item[] \textit{2025}: FMA Annual Meeting (Vancouver), ES World Congress (Seoul), MRS International Risk Conference (Suffolk), IIOC (Philadelphia), Midwest Health Economics Conference (Notre Dame)$^{\dagger}$
